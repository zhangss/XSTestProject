...
//      goto Failed;
      ...
      return;
		...
		if(![newSocket attachStreamsToRunLoop:runLoop error:nil]) [newSocket close]; //goto Failed;
		if(![newSocket configureStreamsAndReturnError:nil])       [newSocket close]; //goto Failed;
		if(![newSocket openStreamsAndReturnError:nil])            [newSocket close]; //goto Failed;
