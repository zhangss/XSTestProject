...
+ (void)registerForNetworkReachabilityNotifications
{
	[[XSReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[XSReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);
}
